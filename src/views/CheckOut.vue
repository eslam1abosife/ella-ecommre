      ...
      <v-row>
        <v-col cols="12" md="6" lg="7" class="order-1 order-md-0">
          ...
          >
            ...
            <div
              class="user_name mt-3 mb-3 d-flex align-center justify-center"
              style="gap: 15px"
            >
              <input
                class="pa-3"
            ...
            />
            <div
              class="city_parent mt-3 mb-3 d-flex align-center justify-center"
              style="gap: 15px"
            >
              <input
                class="pa-3"
        ...
        <v-col cols="12" md="6" lg="5">
          ...
          >
            <v-card
              ...
              width="100%"
              color="transparent"
              class="d-flex align-center pb-2 pt-2 justify-space-between"
            >
